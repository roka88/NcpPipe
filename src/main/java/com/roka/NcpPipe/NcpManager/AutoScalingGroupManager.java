...
public class AutoScalingGroupManager extends AutoScalingGroupConnection {
    ...
    public Function<Object, AutoScalingGroupList> updateAutoScalingGroupForJob(String autoScalingGroupName, String launchConfigurationName, Integer desiredCapacity, Integer minSize, Integer maxSize, Integer defaultCooldown, AutoScalingHealthCheckType healthCheckTypeCode, Integer healthCheckGracePeriod, List<String> zoneNoList) {
    ...
    public Function<Object, CommonResponse> deleteAutoScalingGroupForJob(String autoScalingGroupName) {
        return (result) -> super.deleteAutoScalingGroup(autoScalingGroupName);
    }


    public Function<Object, AutoScalingGroupList> setDesiredCapacityForJob(String autoScalingGroupName, Integer desiredCapacity) {
        return (result) -> super.setDesiredCapacity(autoScalingGroupName, desiredCapacity);
    }


    public Function<Object, CommonResponse> terminateServerInstanceInAutoScalingGroupForJob(String serverInstanceNo, Boolean shouldDecrementDesiredCapacity) {
        return (result) -> super.terminateServerInstanceInAutoScalingGroup(serverInstanceNo, shouldDecrementDesiredCapacity);
    }


    public Function<Object, CommonResponse> setServerInstanceHealthForJob(String healthStatusCode, String serverInstanceNo, Boolean shouldRespectGracePeriod) {
